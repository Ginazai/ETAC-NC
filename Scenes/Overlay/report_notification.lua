...
function scene:create( event )
	...
	local notificationText = display.newText( mainGroup, "Reporte generado con exito!", display.contentCenterX, 90, "Fonts/FORTE.TTF", 35 )
	notificationText.font = native.newFont( "Fonts.FORTE", 16 )
	notificationText:setTextColor( 1 )	

	local confirmText = display.newText( mainGroup, "Aceptar", display.contentCenterX, display.contentCenterY, "Fonts/FORTE.TTF", 35 )
