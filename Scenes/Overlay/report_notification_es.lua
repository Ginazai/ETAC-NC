...
function scene:create( event )
	...
	local notificationText = display.newText( mainGroup, "Reporte creado exitosamente!", display.contentCenterX, 90, "Fonts/FORTE.TTF", 35 )
	notificationText.font = native.newFont( "Fonts.FORTE", 16 )
	notificationText:setTextColor( 1 )	

	local confirmText = display.newText( mainGroup, "Confirmar", display.contentCenterX, display.contentCenterY, "Fonts/FORTE.TTF", 35 )
	confirmText.font = native.newFont( "Fonts.FORTE", 16 )
	confirmText:setTextColor( 1 )	

	local sendData = display.newText( mainGroup, "Enviar", display.contentCenterX, display.contentCenterY + 35, "Fonts/FORTE.TTF", 35 )
