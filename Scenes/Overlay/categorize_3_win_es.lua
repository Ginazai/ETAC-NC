...
local function audioPlayer()
	local options = {"Audio/voice/ES/ganar_1.mp3","Audio/voice/ES/ganar_2.mp3"}
...
local function onContinue() --continue menu handler 
	...
	composer.gotoScene( "Scenes.play_menu_es", { effect="fromTop" } )
end
-----------------------------------------
-- Scenes
-----------------------------------------
...
function scene:hide( event )
	...
	elseif( phase == "did" )then
		...
		composer.hideOverlay( "Scenes.Overlay.categorize_3_win_es" )	--Remove scene when scene goes away	end
	end
end
--scenes listeners
